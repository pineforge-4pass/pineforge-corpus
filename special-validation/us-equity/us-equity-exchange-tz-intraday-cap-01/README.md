> Moved into `special-validation/us-equity/` (categorized layout). Build via
> `bash special-validation/build_specials.sh`; `make_feed.py` lives at the
> special-validation root (`../../make_feed.py`).
