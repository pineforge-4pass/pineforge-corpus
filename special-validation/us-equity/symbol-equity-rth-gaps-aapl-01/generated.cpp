...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        if ((inRth && (is_first_tick_ ? _ta_crossover_2.compute(rsiVal, 30) : _ta_crossover_2.recompute(rsiVal, 30)))) {
            strategy_entry(std::string("Long"), true, na<double>(), na<double>(), na<double>(), "");
        }
        if ((inRth && (is_first_tick_ ? _ta_crossunder_3.compute(rsiVal, 70) : _ta_crossunder_3.recompute(rsiVal, 70)))) {
