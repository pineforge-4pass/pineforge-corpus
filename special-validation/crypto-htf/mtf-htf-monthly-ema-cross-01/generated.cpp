...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::_sec0__ta_ema_1) _pf_value_5;
        decltype(GeneratedStrategy::mema) _pf_value_6;
    ...
    void restore_script_state() override {
        ...
        this->_sec0__ta_ema_1 = _pf_script_state_checkpoint_->_pf_value_5;
        this->mema = _pf_script_state_checkpoint_->_pf_value_6;
    ...
    explicit GeneratedStrategy() : _ta_ema_1(6), _sec0__ta_ema_1(6) {
    ...
    void configure_security_evaluators() override {
        ...
        register_security_eval(0, "M", input_tf_, false, false);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_1 = decltype(this->_ta_ema_1)(6);
        ...
        this->_sec0__ta_ema_1 = decltype(this->_sec0__ta_ema_1)(6);
        this->mema = 0.0;
    ...
    void on_source_bar(const Bar& bar) override {
        mema = _req_sec_0;
        if ((history_advances_new_bar() ? _ta_crossover_2.compute(current_bar_.close, mema) : _ta_crossover_2.recompute(current_bar_.close, mema))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), na<double>(), std::string("close x-over monthly EMA"));
        }
        if ((history_advances_new_bar() ? _ta_crossunder_3.compute(current_bar_.close, mema) : _ta_crossunder_3.recompute(current_bar_.close, mema))) {
            strategy_entry(std::string("S"), false, na<double>(), na<double>(), na<double>(), std::string("close x-under monthly EMA"));
        }
    }
