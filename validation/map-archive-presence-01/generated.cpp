...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_rsi_1 = decltype(this->_ta_rsi_1)(15);
        this->_precalc__ta_rsi_1 = decltype(this->_precalc__ta_rsi_1){};
        this->_ta_ema_2 = decltype(this->_ta_ema_2)(46);
        ...
        this->thresholdArchive = decltype(this->thresholdArchive){};
        this->regimeChoice = std::string("");
        this->fallbackRsi = 0.0;
        this->trendLength = 0;
        this->atrLength = 0;
        this->maximumAtrLoss = 0.0;
        this->hasRequestedRegime = false;
        this->entryRsi = 0.0;
        this->rsiValue = 0.0;
        this->trendLine = 0.0;
        this->atrValue = 0.0;
