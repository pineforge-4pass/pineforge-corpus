...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::macd) _pf_value_3;
        decltype(GeneratedStrategy::sig) _pf_value_4;
        decltype(GeneratedStrategy::_hist) _pf_value_5;
    ...
    void restore_script_state() override {
        ...
        this->macd = _pf_script_state_checkpoint_->_pf_value_3;
        this->sig = _pf_script_state_checkpoint_->_pf_value_4;
        this->_hist = _pf_script_state_checkpoint_->_pf_value_5;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ((history_advances_new_bar() ? _ta_crossover_2.compute(macd, sig) : _ta_crossover_2.recompute(macd, sig))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), na<double>(), std::string("macd cross up"));
        }
        if ((history_advances_new_bar() ? _ta_crossunder_3.compute(macd, sig) : _ta_crossunder_3.recompute(macd, sig))) {
