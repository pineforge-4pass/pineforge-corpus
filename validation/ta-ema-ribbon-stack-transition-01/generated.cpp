...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::prevDir) _pf_value_3;
        decltype(GeneratedStrategy::fastLen) _pf_value_4;
        decltype(GeneratedStrategy::midLen) _pf_value_5;
        decltype(GeneratedStrategy::slowLen) _pf_value_6;
        decltype(GeneratedStrategy::emaFast) _pf_value_7;
        decltype(GeneratedStrategy::emaMid) _pf_value_8;
        decltype(GeneratedStrategy::emaSlow) _pf_value_9;
        decltype(GeneratedStrategy::bullStack) _pf_value_10;
        decltype(GeneratedStrategy::bearStack) _pf_value_11;
    ...
    void restore_script_state() override {
        ...
        this->prevDir = _pf_script_state_checkpoint_->_pf_value_3;
        this->fastLen = _pf_script_state_checkpoint_->_pf_value_4;
        this->midLen = _pf_script_state_checkpoint_->_pf_value_5;
        this->slowLen = _pf_script_state_checkpoint_->_pf_value_6;
        this->emaFast = _pf_script_state_checkpoint_->_pf_value_7;
        this->emaMid = _pf_script_state_checkpoint_->_pf_value_8;
        this->emaSlow = _pf_script_state_checkpoint_->_pf_value_9;
        this->bullStack = _pf_script_state_checkpoint_->_pf_value_10;
        this->bearStack = _pf_script_state_checkpoint_->_pf_value_11;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->prevDir = decltype(this->prevDir)(0);
        this->fastLen = 0;
        this->midLen = 0;
        this->slowLen = 0;
        this->emaFast = 0.0;
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        emaMid = (history_advances_new_bar() ? _ta_ema_2.compute(current_bar_.close) : _ta_ema_2.recompute(current_bar_.close));
        emaSlow = (history_advances_new_bar() ? _ta_ema_3.compute(current_bar_.close) : _ta_ema_3.recompute(current_bar_.close));
        bullStack = (([&]{ auto _pna_l = (emaFast); auto _pna_r = (emaMid); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (emaMid); auto _pna_r = (emaSlow); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()));
        bearStack = (([&]{ auto _pna_l = (emaFast); auto _pna_r = (emaMid); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (emaMid); auto _pna_r = (emaSlow); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()));
        if ((bullStack && ([&]{ auto _pna_l = (prevDir); auto _pna_r = (1); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l != _pna_r); }()))) {
            strategy_entry(std::string("Long"), true, na<double>(), na<double>(), na<double>(), "");
            prevDir = 1;
        }
        if ((bearStack && ([&]{ auto _pna_l = (prevDir); auto _pna_r = ((-1)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (!_pfc_eq); }()))) {
