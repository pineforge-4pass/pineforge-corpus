...
inline bool is_na(const Risk& _z) { return _z.__pf_id < 0; }
...
struct _PFUdtRecord_Risk {
    int64_t cooldown_bars = 0;
    int64_t last_exit_bar = 0;
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Risk> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::cooldown_bars)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::last_exit_bar)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::max_drawdown_pct)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Risk& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::cooldown_bars)>::take(value.cooldown_bars),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::last_exit_bar)>::take(value.last_exit_bar),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::max_drawdown_pct)>::take(value.max_drawdown_pct),
        };
    }
    static void restore(_PFUdtRecord_Risk& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::cooldown_bars)>::restore(value.cooldown_bars, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::last_exit_bar)>::restore(value.last_exit_bar, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Risk::max_drawdown_pct)>::restore(value.max_drawdown_pct, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Risk, _PFUdtRecord_Risk>> {
    using arena_type = _PFUdtArena<Risk, _PFUdtRecord_Risk>;
...
public:
    ...
    _PFUdtArena<Risk, _PFUdtRecord_Risk> _pf_udt_Risk{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Risk)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::risk)>::snapshot_type _pf_value_6;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Risk)>::take(_pf_udt_Risk),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::risk)>::take(risk),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Risk)>::restore(this->_pf_udt_Risk, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::risk)>::restore(this->risk, _pf_script_state_checkpoint_->_pf_value_6);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Risk.reset_for_run();
    ...
    bool _udt_Risk_allowsEntry(Risk self) {
        bool flatOk = ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }());
        bool cooldownOk = ([&]{ auto _pna_l = ((pine_bar_index() - _pf_udt_Risk.read(self).last_exit_bar)); auto _pna_r = (_pf_udt_Risk.read(self).cooldown_bars); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }());
        double ddLimit = (initial_capital_ * _pf_udt_Risk.read(self).max_drawdown_pct);
        bool ddOk = ([&]{ auto _pna_l = (net_profit()); auto _pna_r = ((-ddLimit)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }());
        bool equityOk = ([&]{ auto _pna_l = ((current_equity() + open_profit(current_bar_.close))); auto _pna_r = (0.0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }());
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (((history_advances_new_bar() ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow)) && _udt_Risk_allowsEntry(risk))) {
        ...
        if (((history_advances_new_bar() ? _ta_crossunder_4.compute(emaFast, emaSlow) : _ta_crossunder_4.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 223338299411ULL);
            _pf_udt_Risk.get(risk).last_exit_bar = pine_bar_index();
        }
    }
