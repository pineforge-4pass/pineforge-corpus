...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::fast) _pf_value_6;
        decltype(GeneratedStrategy::slow) _pf_value_7;
        decltype(GeneratedStrategy::cross_up) _pf_value_8;
        decltype(GeneratedStrategy::cross_down) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->fast = _pf_script_state_checkpoint_->_pf_value_6;
        this->slow = _pf_script_state_checkpoint_->_pf_value_7;
        this->cross_up = _pf_script_state_checkpoint_->_pf_value_8;
        this->cross_down = _pf_script_state_checkpoint_->_pf_value_9;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_sma_1 = decltype(this->_ta_sma_1)(5);
