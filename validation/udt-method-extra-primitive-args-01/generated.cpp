...
struct _PFCheckpointTraits<_PFUdtRecord_Cfg> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::base)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::bias)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Cfg& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::base)>::take(value.base),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::bias)>::take(value.bias),
        };
    }
    static void restore(_PFUdtRecord_Cfg& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::base)>::restore(value.base, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Cfg::bias)>::restore(value.bias, snapshot._pf_field_1);
    }
};
...
public:
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::cfg)>::snapshot_type _pf_value_4;
        _PFCheckpointTraits<decltype(GeneratedStrategy::upOff)>::snapshot_type _pf_value_5;
        _PFCheckpointTraits<decltype(GeneratedStrategy::downOff)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::snapshot_type _pf_value_9;
    };
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::upOff)>::take(upOff),
            _PFCheckpointTraits<decltype(GeneratedStrategy::downOff)>::take(downOff),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::cfg)>::restore(this->cfg, _pf_script_state_checkpoint_->_pf_value_4);
        _PFCheckpointTraits<decltype(GeneratedStrategy::upOff)>::restore(this->upOff, _pf_script_state_checkpoint_->_pf_value_5);
        _PFCheckpointTraits<decltype(GeneratedStrategy::downOff)>::restore(this->downOff, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::restore(this->_var_initialized, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::restore(this->_ta_initialized_, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::restore(this->_inputs_initialized_, _pf_script_state_checkpoint_->_pf_value_9);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    double _udt_Cfg_offset(Cfg self, int n, double mult, bool flip) {
        int sign = ((flip) ? ((-1)) : (1));
        return ((_pf_udt_Cfg.read(self).base + ((mult * (double)(n)) * (double)(sign))) + _pf_udt_Cfg.read(self).bias);
    }

    void on_source_bar(const Bar& bar) override {
        if (!_var_initialized) {
            cfg = _pf_udt_Cfg.create(_PFUdtRecord_Cfg{.base = 0.0, .bias = 0.0});
            _var_initialized = true;
        } else {
        }
        _pf_udt_Cfg.get(cfg).base = current_bar_.close;
        upOff = _udt_Cfg_offset(cfg, 5, 0.1, false);
        downOff = _udt_Cfg_offset(cfg, 5, 0.1, true);
        if (((history_advances_new_bar() ? _ta_crossover_2.compute(current_bar_.close, (history_advances_new_bar() ? _ta_sma_1.compute(current_bar_.close) : _ta_sma_1.recompute(current_bar_.close))) : _ta_crossover_2.recompute(current_bar_.close, (history_advances_new_bar() ? _ta_sma_1.compute(current_bar_.close) : _ta_sma_1.recompute(current_bar_.close)))) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("entry long"), "", 0, -1);
            strategy_exit(std::string("LX"), std::string("L"), upOff, downOff, na<double>(), na<double>(), na<double>(), 100.0, std::string("bracket long"), na<double>(), "", na<double>(), na<double>());
        }
    }
