...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::i_left) _pf_value_4;
        decltype(GeneratedStrategy::i_right) _pf_value_5;
        decltype(GeneratedStrategy::ph) _pf_value_6;
        decltype(GeneratedStrategy::pl) _pf_value_7;
        decltype(GeneratedStrategy::long_break) _pf_value_8;
        decltype(GeneratedStrategy::short_break) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->i_left = _pf_script_state_checkpoint_->_pf_value_4;
        this->i_right = _pf_script_state_checkpoint_->_pf_value_5;
        this->ph = _pf_script_state_checkpoint_->_pf_value_6;
        this->pl = _pf_script_state_checkpoint_->_pf_value_7;
        this->long_break = _pf_script_state_checkpoint_->_pf_value_8;
        this->short_break = _pf_script_state_checkpoint_->_pf_value_9;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_pivothigh_1 = decltype(this->_ta_pivothigh_1)(4, 4);
        this->_precalc__ta_pivothigh_1 = decltype(this->_precalc__ta_pivothigh_1){};
        this->_ta_pivotlow_2 = decltype(this->_ta_pivotlow_2)(4, 4);
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ((long_break && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) || _pfc_eq); }()))) {
            if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }())) {
                strategy_close(std::string("S"), std::string("flip flat"), na<double>(), na<double>(), false, 240518168599ULL);
            }
        ...
        if ((short_break && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }()))) {
            if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
                strategy_close(std::string("L"), std::string("flip flat"), na<double>(), na<double>(), false, 261993005079ULL);
            }
