...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        sample = mask.get((int)(((([&]{ auto _pna_l = (h); auto _pna_r = (24); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l < _pna_r); }())) ? (h) : (0))), (int)((((([&]{ auto _pna_l = (d); auto _pna_r = (0); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }()) && ([&]{ auto _pna_l = (d); auto _pna_r = (7); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l < _pna_r); }()))) ? (d) : (0))));
        hotCount = 0;
        int _for_start_0 = (0);
        int _for_end_0 = (23);
        int _for_step_0 = (1);
