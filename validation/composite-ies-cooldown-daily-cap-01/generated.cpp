...
public:
    ...
    struct _PFScriptState {
        decltype(GeneratedStrategy::_ta_change_1) _pf_value_0;
        ...
        decltype(GeneratedStrategy::bars_since_trade) _pf_value_5;
        decltype(GeneratedStrategy::daily_trades) _pf_value_6;
        decltype(GeneratedStrategy::i_fast_ema) _pf_value_7;
        decltype(GeneratedStrategy::i_slow_ema) _pf_value_8;
        decltype(GeneratedStrategy::i_cooldown) _pf_value_9;
        decltype(GeneratedStrategy::i_max_trades) _pf_value_10;
        decltype(GeneratedStrategy::new_day) _pf_value_11;
        decltype(GeneratedStrategy::emaFast) _pf_value_12;
        decltype(GeneratedStrategy::emaSlow) _pf_value_13;
        decltype(GeneratedStrategy::raw_long_signal) _pf_value_14;
        decltype(GeneratedStrategy::cooldown_ok) _pf_value_15;
        decltype(GeneratedStrategy::daily_cap_ok) _pf_value_16;
    ...
    void restore_script_state() override {
        ...
        this->_ta_change_1 = _pf_script_state_checkpoint_->_pf_value_0;
        ...
        this->bars_since_trade = _pf_script_state_checkpoint_->_pf_value_5;
        this->daily_trades = _pf_script_state_checkpoint_->_pf_value_6;
        this->i_fast_ema = _pf_script_state_checkpoint_->_pf_value_7;
        this->i_slow_ema = _pf_script_state_checkpoint_->_pf_value_8;
        this->i_cooldown = _pf_script_state_checkpoint_->_pf_value_9;
        this->i_max_trades = _pf_script_state_checkpoint_->_pf_value_10;
        this->new_day = _pf_script_state_checkpoint_->_pf_value_11;
        this->emaFast = _pf_script_state_checkpoint_->_pf_value_12;
        this->emaSlow = _pf_script_state_checkpoint_->_pf_value_13;
        this->raw_long_signal = _pf_script_state_checkpoint_->_pf_value_14;
        this->cooldown_ok = _pf_script_state_checkpoint_->_pf_value_15;
        this->daily_cap_ok = _pf_script_state_checkpoint_->_pf_value_16;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->daily_trades = decltype(this->daily_trades)(0);
        this->i_fast_ema = 0;
        this->i_slow_ema = 0;
        this->i_cooldown = 0;
        this->i_max_trades = 0;
        ...
        this->emaFast = 0.0;
        this->emaSlow = 0.0;
        this->raw_long_signal = false;
        this->cooldown_ok = false;
        this->daily_cap_ok = false;
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        new_day = ([&]{ auto _pna_l = ((history_advances_new_bar() ? _ta_change_1.compute(pine_time(current_bar_.timestamp, std::string("D"), std::string(""), std::string(""), script_tf_ PF_PINE_TIME_SESSION_DAY_ARGS(syminfo_.timezone, syminfo_.session))) : _ta_change_1.recompute(pine_time(current_bar_.timestamp, std::string("D"), std::string(""), std::string(""), script_tf_ PF_PINE_TIME_SESSION_DAY_ARGS(syminfo_.timezone, syminfo_.session))))); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (!_pfc_eq); }());
        if (new_day) {
            daily_trades = 0;
        }
        ...
        raw_long_signal = ((history_advances_new_bar() ? _ta_crossover_4.compute(emaFast, emaSlow) : _ta_crossover_4.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()));
        cooldown_ok = ([&]{ auto _pna_l = (bars_since_trade); auto _pna_r = (i_cooldown); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }());
        daily_cap_ok = ([&]{ auto _pna_l = (daily_trades); auto _pna_r = (i_max_trades); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l < _pna_r); }());
        ...
        if (((history_advances_new_bar() ? _ta_crossunder_5.compute(emaFast, emaSlow) : _ta_crossunder_5.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 309237645331ULL);
        }
    }
