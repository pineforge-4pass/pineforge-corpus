...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::bbLen) _pf_value_2;
        decltype(GeneratedStrategy::bbMult) _pf_value_3;
        decltype(GeneratedStrategy::rsiLen) _pf_value_4;
        decltype(GeneratedStrategy::rsiOB) _pf_value_5;
        decltype(GeneratedStrategy::rsiOS) _pf_value_6;
        decltype(GeneratedStrategy::bbMid) _pf_value_7;
        decltype(GeneratedStrategy::bbUpper) _pf_value_8;
        decltype(GeneratedStrategy::bbLower) _pf_value_9;
        decltype(GeneratedStrategy::rsiVal) _pf_value_10;
    ...
    void restore_script_state() override {
        ...
        this->bbLen = _pf_script_state_checkpoint_->_pf_value_2;
        this->bbMult = _pf_script_state_checkpoint_->_pf_value_3;
        this->rsiLen = _pf_script_state_checkpoint_->_pf_value_4;
        this->rsiOB = _pf_script_state_checkpoint_->_pf_value_5;
        this->rsiOS = _pf_script_state_checkpoint_->_pf_value_6;
        this->bbMid = _pf_script_state_checkpoint_->_pf_value_7;
        this->bbUpper = _pf_script_state_checkpoint_->_pf_value_8;
        this->bbLower = _pf_script_state_checkpoint_->_pf_value_9;
        this->rsiVal = _pf_script_state_checkpoint_->_pf_value_10;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_rsi_2 = decltype(this->_ta_rsi_2)(14);
        this->_precalc__ta_rsi_2 = decltype(this->_precalc__ta_rsi_2){};
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        rsiVal = (history_advances_new_bar() ? _ta_rsi_2.compute(current_bar_.close) : _ta_rsi_2.recompute(current_bar_.close));
        longCond = (([&]{ auto _pna_l = (current_bar_.close); auto _pna_r = (bbLower); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (rsiVal); auto _pna_r = (rsiOS); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()));
        shortCond = (([&]{ auto _pna_l = (current_bar_.close); auto _pna_r = (bbUpper); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && ([&]{ auto _pna_l = (rsiVal); auto _pna_r = (rsiOB); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()));
        if (longCond) {
