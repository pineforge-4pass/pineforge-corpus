...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_1 = decltype(this->_ta_ema_1)(42);
        this->_precalc__ta_ema_1 = decltype(this->_precalc__ta_ema_1){};
        this->_ta_atr_2 = decltype(this->_ta_atr_2)(16);
        ...
        this->trendLength = 0;
        this->atrLength = 0;
        this->firstPullback = 0.0;
        this->secondPullback = 0.0;
        this->stopAtr = 0.0;
        this->atrValue = 0.0;
        this->risingTrend = false;
        this->firstTerrace = 0.0;
        this->secondTerrace = 0.0;
