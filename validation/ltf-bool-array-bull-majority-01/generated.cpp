...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::ltfBullArr) _pf_value_4;
        decltype(GeneratedStrategy::bullCount) _pf_value_5;
        decltype(GeneratedStrategy::emaFast) _pf_value_6;
        decltype(GeneratedStrategy::emaSlow) _pf_value_7;
        decltype(GeneratedStrategy::entryCond) _pf_value_8;
        decltype(GeneratedStrategy::exitCond) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->ltfBullArr = _pf_script_state_checkpoint_->_pf_value_4;
        this->bullCount = _pf_script_state_checkpoint_->_pf_value_5;
        this->emaFast = _pf_script_state_checkpoint_->_pf_value_6;
        this->emaSlow = _pf_script_state_checkpoint_->_pf_value_7;
        this->entryCond = _pf_script_state_checkpoint_->_pf_value_8;
        this->exitCond = _pf_script_state_checkpoint_->_pf_value_9;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->ltfBullArr = decltype(this->ltfBullArr){};
        this->bullCount = 0;
        this->emaFast = 0.0;
        this->emaSlow = 0.0;
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        bullCount = 0;
        if (([&]{ auto _pna_l = ((double)ltfBullArr.size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
            int _for_start_0 = (0);
            int _for_end_0 = [&](){ double _pf_v = (double)((((double)ltfBullArr.size() - 1))); return is_na(_pf_v) ? na<int>() : (int)_pf_v; }();
            int _for_step_0 = (1);
        ...
        entryCond = (([&]{ auto _pna_l = (bullCount); auto _pna_r = (9); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }()) && ([&]{ auto _pna_l = (emaFast); auto _pna_r = (emaSlow); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()));
        exitCond = (([&]{ auto _pna_l = (bullCount); auto _pna_r = (6); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l <= _pna_r); }()) || ([&]{ auto _pna_l = (emaFast); auto _pna_r = (emaSlow); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()));
        ...
        if ((exitCond && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("bull-broken"), na<double>(), na<double>(), false, 188978561043ULL);
        }
    }
    ...
    void _eval_security_0(const Bar& bar, bool is_complete) {
        ...
        _req_sec_lower_tf_0.push_back(([&]{ auto _pna_l = (bar.close); auto _pna_r = (bar.open); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()));
    }
