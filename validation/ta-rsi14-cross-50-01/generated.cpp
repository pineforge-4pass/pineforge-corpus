...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::rsi) _pf_value_3;
    ...
    void restore_script_state() override {
        ...
        this->rsi = _pf_script_state_checkpoint_->_pf_value_3;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ((history_advances_new_bar() ? _ta_crossover_2.compute(rsi, 50.0) : _ta_crossover_2.recompute(rsi, 50.0))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), na<double>(), std::string("rsi cross up 50"));
        }
        if ((history_advances_new_bar() ? _ta_crossunder_3.compute(rsi, 50.0) : _ta_crossunder_3.recompute(rsi, 50.0))) {
