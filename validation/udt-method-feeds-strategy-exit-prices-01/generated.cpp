...
inline bool is_na(const Bracket& _z) { return _z.__pf_id < 0; }
...
struct _PFUdtRecord_Bracket {
    double entry_px = 0.0;
    double entry_atr = 0.0;
    double stop_mult = 0.0;
    double limit_mult = 0.0;
};
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Bracket> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_px)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_atr)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::stop_mult)>::snapshot_type _pf_field_2;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::limit_mult)>::snapshot_type _pf_field_3;
    };
    static snapshot_type take(const _PFUdtRecord_Bracket& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_px)>::take(value.entry_px),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_atr)>::take(value.entry_atr),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::stop_mult)>::take(value.stop_mult),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::limit_mult)>::take(value.limit_mult),
        };
    }
    static void restore(_PFUdtRecord_Bracket& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_px)>::restore(value.entry_px, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::entry_atr)>::restore(value.entry_atr, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::stop_mult)>::restore(value.stop_mult, snapshot._pf_field_2);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Bracket::limit_mult)>::restore(value.limit_mult, snapshot._pf_field_3);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Bracket, _PFUdtRecord_Bracket>> {
    using arena_type = _PFUdtArena<Bracket, _PFUdtRecord_Bracket>;
...
public:
    ...
    _PFUdtArena<Bracket, _PFUdtRecord_Bracket> _pf_udt_Bracket{&_pf_udt_undo};
    ta::ATR _ta_atr_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Bracket)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::br)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::atrVal)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::snapshot_type _pf_value_12;
    };
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Bracket)>::take(_pf_udt_Bracket),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::br)>::take(br),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Bracket)>::restore(this->_pf_udt_Bracket, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::br)>::restore(this->br, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::atrVal)>::restore(this->atrVal, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::restore(this->emaFast, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::restore(this->emaSlow, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::restore(this->_var_initialized, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::restore(this->_ta_initialized_, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::restore(this->_inputs_initialized_, _pf_script_state_checkpoint_->_pf_value_12);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Bracket.reset_for_run();
    ...
    double _udt_Bracket_stopPrice(Bracket self) {
        return (_pf_udt_Bracket.read(self).entry_px - (_pf_udt_Bracket.read(self).entry_atr * _pf_udt_Bracket.read(self).stop_mult));
    }

    double _udt_Bracket_limitPrice(Bracket self) {
        return (_pf_udt_Bracket.read(self).entry_px + (_pf_udt_Bracket.read(self).entry_atr * _pf_udt_Bracket.read(self).limit_mult));
    }

    void on_source_bar(const Bar& bar) override {
        if (!_var_initialized) {
            br = _pf_udt_Bracket.create(_PFUdtRecord_Bracket{.entry_px = na<double>(), .entry_atr = na<double>(), .stop_mult = 1.5, .limit_mult = 3.0});
        ...
        if (((history_advances_new_bar() ? _ta_crossover_4.compute(emaFast, emaSlow) : _ta_crossover_4.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            _pf_udt_Bracket.get(br).entry_px = current_bar_.close;
            _pf_udt_Bracket.get(br).entry_atr = atrVal;
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("entry long"), "", 0, -1);
            strategy_exit(std::string("LX"), std::string("L"), _udt_Bracket_limitPrice(br), _udt_Bracket_stopPrice(br), na<double>(), na<double>(), na<double>(), 100.0, std::string("bracket from method"), na<double>(), "", na<double>(), na<double>());
        }
    }
