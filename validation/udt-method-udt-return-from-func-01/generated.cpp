...
struct _PFCheckpointTraits<_PFUdtRecord_Sample> {
    struct snapshot_type {
        ...
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::weight)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Sample& value) {
        return snapshot_type{
            ...
            _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::weight)>::take(value.weight),
        };
    }
    static void restore(_PFUdtRecord_Sample& value, const snapshot_type& snapshot) {
        ...
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::weight)>::restore(value.weight, snapshot._pf_field_2);
    }
};
...
public:
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::rsiVal)>::snapshot_type _pf_value_7;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::s)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::sc)>::snapshot_type _pf_value_11;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::sc)>::take(sc),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::rsiVal)>::restore(this->rsiVal, _pf_script_state_checkpoint_->_pf_value_7);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::s)>::restore(this->s, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::sc)>::restore(this->sc, _pf_script_state_checkpoint_->_pf_value_11);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    double _udt_Sample_score(Sample self) {
        ...
        if ((is_na(_pf_udt_Sample.read(self).price) || is_na(_pf_udt_Sample.read(self).rsi))) {
            ...
            _func_ret = (((_pf_udt_Sample.read(self).rsi - 50.0) * 0.1) * _pf_udt_Sample.read(self).weight);
        }
        return _func_ret;
    }

    Sample build_sample(double price, double rsi, double weight) {
        return _pf_udt_Sample.create(_PFUdtRecord_Sample{.price = price, .rsi = rsi, .weight = weight});
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (((history_advances_new_bar() ? _ta_crossunder_5.compute(emaFast, emaSlow) : _ta_crossunder_5.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 287762808851ULL);
        }
    }
