...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::kama) _pf_value_4;
        decltype(GeneratedStrategy::i_kama_len) _pf_value_5;
        decltype(GeneratedStrategy::i_kama_fast) _pf_value_6;
        decltype(GeneratedStrategy::i_kama_slow) _pf_value_7;
        decltype(GeneratedStrategy::change_n) _pf_value_8;
        decltype(GeneratedStrategy::vol_sum) _pf_value_9;
        decltype(GeneratedStrategy::er) _pf_value_10;
        decltype(GeneratedStrategy::fast_sc) _pf_value_11;
        decltype(GeneratedStrategy::slow_sc) _pf_value_12;
        decltype(GeneratedStrategy::sc) _pf_value_13;
        decltype(GeneratedStrategy::cross_up) _pf_value_14;
        decltype(GeneratedStrategy::cross_down) _pf_value_15;
    ...
    void restore_script_state() override {
        ...
        this->kama = _pf_script_state_checkpoint_->_pf_value_4;
        this->i_kama_len = _pf_script_state_checkpoint_->_pf_value_5;
        this->i_kama_fast = _pf_script_state_checkpoint_->_pf_value_6;
        this->i_kama_slow = _pf_script_state_checkpoint_->_pf_value_7;
        this->change_n = _pf_script_state_checkpoint_->_pf_value_8;
        this->vol_sum = _pf_script_state_checkpoint_->_pf_value_9;
        this->er = _pf_script_state_checkpoint_->_pf_value_10;
        this->fast_sc = _pf_script_state_checkpoint_->_pf_value_11;
        this->slow_sc = _pf_script_state_checkpoint_->_pf_value_12;
        this->sc = _pf_script_state_checkpoint_->_pf_value_13;
        this->cross_up = _pf_script_state_checkpoint_->_pf_value_14;
        this->cross_down = _pf_script_state_checkpoint_->_pf_value_15;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        cross_up = (history_advances_new_bar() ? _ta_crossover_2.compute(current_bar_.close, kama[0]) : _ta_crossover_2.recompute(current_bar_.close, kama[0]));
        cross_down = (history_advances_new_bar() ? _ta_crossunder_3.compute(current_bar_.close, kama[0]) : _ta_crossunder_3.recompute(current_bar_.close, kama[0]));
