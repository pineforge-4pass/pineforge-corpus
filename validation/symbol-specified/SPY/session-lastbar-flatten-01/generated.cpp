...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::_ta_initialized_) _pf_value_3;
    ...
    void restore_script_state() override {
        ...
        this->_ta_initialized_ = _pf_script_state_checkpoint_->_pf_value_3;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ([&](){ auto _pf_bool_v = (session_islastbar_); using _pf_bool_t = std::decay_t<decltype(_pf_bool_v)>; if constexpr (std::is_same_v<_pf_bool_t, bool>) { return _pf_bool_v; } else if constexpr (std::is_floating_point_v<_pf_bool_t> || std::is_integral_v<_pf_bool_t>) { return is_na(_pf_bool_v) ? false : (_pf_bool_v != 0); } else { return static_cast<bool>(_pf_bool_v); } }()) {
            strategy_close("", "", na<double>(), na<double>(), false);
        }
    }
