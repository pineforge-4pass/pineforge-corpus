...
inline bool is_na(const Signal& _z) { return _z.__pf_id < 0; }
...
struct _PFUdtRecord_Signal {
    int64_t last_long_bar = 0;
    int64_t last_short_bar = 0;
    int64_t debounce = 0;
};
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Signal> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_long_bar)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_short_bar)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::debounce)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Signal& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_long_bar)>::take(value.last_long_bar),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_short_bar)>::take(value.last_short_bar),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::debounce)>::take(value.debounce),
        };
    }
    static void restore(_PFUdtRecord_Signal& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_long_bar)>::restore(value.last_long_bar, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::last_short_bar)>::restore(value.last_short_bar, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Signal::debounce)>::restore(value.debounce, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Signal, _PFUdtRecord_Signal>> {
    using arena_type = _PFUdtArena<Signal, _PFUdtRecord_Signal>;
...
public:
    ...
    _PFUdtArena<Signal, _PFUdtRecord_Signal> _pf_udt_Signal{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Signal)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::sig)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::xUp)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::xDown)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::snapshot_type _pf_value_12;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::snapshot_type _pf_value_13;
    };
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Signal)>::take(_pf_udt_Signal),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::sig)>::take(sig),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::xUp)>::take(xUp),
            _PFCheckpointTraits<decltype(GeneratedStrategy::xDown)>::take(xDown),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Signal)>::restore(this->_pf_udt_Signal, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::sig)>::restore(this->sig, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::restore(this->emaFast, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::restore(this->emaSlow, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::xUp)>::restore(this->xUp, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::xDown)>::restore(this->xDown, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::restore(this->_var_initialized, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::restore(this->_ta_initialized_, _pf_script_state_checkpoint_->_pf_value_12);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::restore(this->_inputs_initialized_, _pf_script_state_checkpoint_->_pf_value_13);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Signal.reset_for_run();
    ...
    bool _udt_Signal_shouldEnterLong(Signal self, bool cross) {
        bool spaced = ([&]{ auto _pna_l = ((pine_bar_index() - _pf_udt_Signal.read(self).last_long_bar)); auto _pna_r = (_pf_udt_Signal.read(self).debounce); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }());
        bool ok = (cross && spaced);
        if (ok) {
            _pf_udt_Signal.get(self).last_long_bar = pine_bar_index();
        }
        return ok;
    }

    bool _udt_Signal_shouldEnterShort(Signal self, bool cross) {
        bool spaced = ([&]{ auto _pna_l = ((pine_bar_index() - _pf_udt_Signal.read(self).last_short_bar)); auto _pna_r = (_pf_udt_Signal.read(self).debounce); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }());
        bool ok = (cross && spaced);
        if (ok) {
            _pf_udt_Signal.get(self).last_short_bar = pine_bar_index();
        }
        return ok;
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        xUp = (history_advances_new_bar() ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow));
        xDown = (history_advances_new_bar() ? _ta_crossunder_4.compute(emaFast, emaSlow) : _ta_crossunder_4.recompute(emaFast, emaSlow));
        if (_udt_Signal_shouldEnterLong(sig, xUp)) {
            if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }())) {
                strategy_close(std::string("S"), std::string("flip to long"), na<double>(), na<double>(), false, 240518168599ULL);
            }
        ...
        if (_udt_Signal_shouldEnterShort(sig, xDown)) {
            if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
                strategy_close(std::string("L"), std::string("flip to short"), na<double>(), na<double>(), false, 261993005079ULL);
            }
