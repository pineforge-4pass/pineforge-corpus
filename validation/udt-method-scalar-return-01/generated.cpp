...
struct _PFCheckpointTraits<_PFUdtRecord_Box> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::k)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::bias)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Box& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Box::k)>::take(value.k),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Box::bias)>::take(value.bias),
        };
    }
    static void restore(_PFUdtRecord_Box& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::k)>::restore(value.k, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::bias)>::restore(value.bias, snapshot._pf_field_1);
    }
};
...
public:
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::b)>::snapshot_type _pf_value_7;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::snapshot_type _pf_value_12;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::b)>::take(b),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::b)>::restore(this->b, _pf_script_state_checkpoint_->_pf_value_7);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::restore(this->entryCond, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::restore(this->exitCond, _pf_script_state_checkpoint_->_pf_value_12);
