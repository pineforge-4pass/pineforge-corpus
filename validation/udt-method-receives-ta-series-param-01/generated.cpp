...
inline bool is_na(const Filter& _z) { return _z.__pf_id < 0; }
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Filter> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_min)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_max)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::atr_min)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Filter& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_min)>::take(value.rsi_min),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_max)>::take(value.rsi_max),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::atr_min)>::take(value.atr_min),
        };
    }
    static void restore(_PFUdtRecord_Filter& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_min)>::restore(value.rsi_min, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::rsi_max)>::restore(value.rsi_max, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Filter::atr_min)>::restore(value.atr_min, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Filter, _PFUdtRecord_Filter>> {
    using arena_type = _PFUdtArena<Filter, _PFUdtRecord_Filter>;
...
public:
    ...
    _PFUdtArena<Filter, _PFUdtRecord_Filter> _pf_udt_Filter{&_pf_udt_undo};
    ta::RSI _ta_rsi_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Filter)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::filt)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::rsiVal)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaVal)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::atrVal)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::xUp)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::xDown)>::snapshot_type _pf_value_12;
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::snapshot_type _pf_value_13;
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::snapshot_type _pf_value_14;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Filter)>::take(_pf_udt_Filter),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::filt)>::take(filt),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Filter)>::restore(this->_pf_udt_Filter, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::filt)>::restore(this->filt, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::rsiVal)>::restore(this->rsiVal, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaVal)>::restore(this->emaVal, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::atrVal)>::restore(this->atrVal, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::xUp)>::restore(this->xUp, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::xDown)>::restore(this->xDown, _pf_script_state_checkpoint_->_pf_value_12);
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::restore(this->entryCond, _pf_script_state_checkpoint_->_pf_value_13);
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::restore(this->exitCond, _pf_script_state_checkpoint_->_pf_value_14);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Filter.reset_for_run();
    ...
    bool _udt_Filter_confirms(Filter self, double rsi, double ema, double atr) {
        bool rsiOk = (([&]{ auto _pna_l = (rsi); auto _pna_r = (_pf_udt_Filter.read(self).rsi_min); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }()) && ([&]{ auto _pna_l = (rsi); auto _pna_r = (_pf_udt_Filter.read(self).rsi_max); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) || _pfc_eq); }()));
        bool emaOk = ([&]{ auto _pna_l = (current_bar_.close); auto _pna_r = (ema); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }());
        bool atrOk = ([&]{ auto _pna_l = (atr); auto _pna_r = (_pf_udt_Filter.read(self).atr_min); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }());
        return ((rsiOk && emaOk) && atrOk);
    }

    void on_source_bar(const Bar& bar) override {
        if (!_var_initialized) {
            filt = _pf_udt_Filter.create(_PFUdtRecord_Filter{.rsi_min = 40.0, .rsi_max = 90.0, .atr_min = 0.0});
        ...
        xUp = (history_advances_new_bar() ? _ta_crossover_4.compute(current_bar_.close, emaVal) : _ta_crossover_4.recompute(current_bar_.close, emaVal));
        xDown = (history_advances_new_bar() ? _ta_crossunder_5.compute(current_bar_.close, emaVal) : _ta_crossunder_5.recompute(current_bar_.close, emaVal));
        ...
        if ((exitCond && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 244813135891ULL);
        }
    }
