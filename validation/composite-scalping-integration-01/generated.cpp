...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::i_tp_tk) _pf_value_6;
        decltype(GeneratedStrategy::i_sl_tk) _pf_value_7;
        decltype(GeneratedStrategy::ema_fast) _pf_value_8;
        decltype(GeneratedStrategy::ema_slow) _pf_value_9;
        decltype(GeneratedStrategy::long_signal) _pf_value_10;
        decltype(GeneratedStrategy::short_signal) _pf_value_11;
        decltype(GeneratedStrategy::entry_px) _pf_value_12;
        decltype(GeneratedStrategy::tp_px) _pf_value_13;
        decltype(GeneratedStrategy::sl_px) _pf_value_14;
    ...
    void restore_script_state() override {
        ...
        this->i_tp_tk = _pf_script_state_checkpoint_->_pf_value_6;
        this->i_sl_tk = _pf_script_state_checkpoint_->_pf_value_7;
        this->ema_fast = _pf_script_state_checkpoint_->_pf_value_8;
        this->ema_slow = _pf_script_state_checkpoint_->_pf_value_9;
        this->long_signal = _pf_script_state_checkpoint_->_pf_value_10;
        this->short_signal = _pf_script_state_checkpoint_->_pf_value_11;
        this->entry_px = _pf_script_state_checkpoint_->_pf_value_12;
        this->tp_px = _pf_script_state_checkpoint_->_pf_value_13;
        this->sl_px = _pf_script_state_checkpoint_->_pf_value_14;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_1 = decltype(this->_ta_ema_1)(5);
        this->_precalc__ta_ema_1 = decltype(this->_precalc__ta_ema_1){};
        this->_ta_ema_2 = decltype(this->_ta_ema_2)(13);
