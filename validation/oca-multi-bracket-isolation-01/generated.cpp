...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::rsiVal) _pf_value_5;
        decltype(GeneratedStrategy::atrVal) _pf_value_6;
        ...
        decltype(GeneratedStrategy::entry) _pf_value_10;
    ...
    void restore_script_state() override {
        ...
        this->rsiVal = _pf_script_state_checkpoint_->_pf_value_5;
        this->atrVal = _pf_script_state_checkpoint_->_pf_value_6;
        ...
        this->entry = _pf_script_state_checkpoint_->_pf_value_10;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        entryCond = ((history_advances_new_bar() ? _ta_crossover_5.compute(emaFast, emaSlow) : _ta_crossover_5.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (rsiVal); auto _pna_r = (60); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()));
        ...
        if (([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) {
            entry = (signed_position_size() == 0.0 ? na<double>() : position_entry_price_);
            strategy_exit(std::string("X_A"), std::string("L"), (entry + (atrVal * 1.0)), (entry - (atrVal * 1.0)), na<double>(), na<double>(), na<double>(), 100.0, "", 1, std::string("GRP_A"), na<double>(), na<double>());
            strategy_exit(std::string("X_B"), std::string("L"), (entry + (atrVal * 2.0)), (entry - (atrVal * 2.0)), na<double>(), na<double>(), na<double>(), 100.0, "", 1, std::string("GRP_B"), na<double>(), na<double>());
        }
    }
