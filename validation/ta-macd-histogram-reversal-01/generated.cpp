...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::fastLen) _pf_value_3;
        decltype(GeneratedStrategy::slowLen) _pf_value_4;
        ...
        decltype(GeneratedStrategy::signalLine) _pf_value_8;
        decltype(GeneratedStrategy::histLine) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->fastLen = _pf_script_state_checkpoint_->_pf_value_3;
        this->slowLen = _pf_script_state_checkpoint_->_pf_value_4;
        ...
        this->signalLine = _pf_script_state_checkpoint_->_pf_value_8;
        this->histLine = _pf_script_state_checkpoint_->_pf_value_9;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        auto _result__ta_macd_1 = (history_advances_new_bar() ? _ta_macd_1.compute(src) : _ta_macd_1.recompute(src));
