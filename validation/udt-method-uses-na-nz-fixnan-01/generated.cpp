...
struct _PFCheckpointTraits<_PFUdtRecord_Sample> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::prev)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::ratio)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Sample& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::prev)>::take(value.prev),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::ratio)>::take(value.ratio),
        };
    }
    static void restore(_PFUdtRecord_Sample& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::prev)>::restore(value.prev, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Sample::ratio)>::restore(value.ratio, snapshot._pf_field_1);
    }
};
...
public:
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::s)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::snapshot_type _pf_value_7;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::snapshot_type _pf_value_12;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::snapshot_type _pf_value_13;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::snapshot_type _pf_value_14;
    };
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::take(r),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::s)>::restore(this->s, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::restore(this->r, _pf_script_state_checkpoint_->_pf_value_7);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::entryCond)>::restore(this->entryCond, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::exitCond)>::restore(this->exitCond, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::restore(this->_var_initialized, _pf_script_state_checkpoint_->_pf_value_12);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::restore(this->_ta_initialized_, _pf_script_state_checkpoint_->_pf_value_13);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::restore(this->_inputs_initialized_, _pf_script_state_checkpoint_->_pf_value_14);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    double _udt_Sample_safeRatio(Sample self, double curr) {
        double p = ([&]{ auto _nz_v = (_pf_udt_Sample.read(self).prev); return is_na(_nz_v) ? (curr) : _nz_v; }());
        double r = ((([&]{ auto _pna_l = (p); auto _pna_r = (0.0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }())) ? (1.0) : (((double)(curr) / (double)(p))));
        _pf_udt_Sample.get(self).prev = curr;
        _pf_udt_Sample.get(self).ratio = r;
        return ((is_na(_pf_udt_Sample.read(self).ratio)) ? (1.0) : (_pf_udt_Sample.read(self).ratio));
    }

    void on_source_bar(const Bar& bar) override {
        if (!_var_initialized) {
            s = _pf_udt_Sample.create(_PFUdtRecord_Sample{.prev = na<double>(), .ratio = na<double>()});
        ...
        entryCond = (((history_advances_new_bar() ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (r); auto _pna_r = (1.0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) && !(is_na(r)));
        ...
        if ((exitCond && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 214748364819ULL);
        }
    }
