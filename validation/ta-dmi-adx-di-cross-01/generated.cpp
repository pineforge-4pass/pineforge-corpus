...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::diLen) _pf_value_3;
        decltype(GeneratedStrategy::adxSmooth) _pf_value_4;
        decltype(GeneratedStrategy::adxThresh) _pf_value_5;
        decltype(GeneratedStrategy::diPlus) _pf_value_6;
        decltype(GeneratedStrategy::diMinus) _pf_value_7;
        decltype(GeneratedStrategy::adxVal) _pf_value_8;
        decltype(GeneratedStrategy::bullCross) _pf_value_9;
        decltype(GeneratedStrategy::bearCross) _pf_value_10;
    ...
    void restore_script_state() override {
        ...
        this->diLen = _pf_script_state_checkpoint_->_pf_value_3;
        this->adxSmooth = _pf_script_state_checkpoint_->_pf_value_4;
        this->adxThresh = _pf_script_state_checkpoint_->_pf_value_5;
        this->diPlus = _pf_script_state_checkpoint_->_pf_value_6;
        this->diMinus = _pf_script_state_checkpoint_->_pf_value_7;
        this->adxVal = _pf_script_state_checkpoint_->_pf_value_8;
        this->bullCross = _pf_script_state_checkpoint_->_pf_value_9;
        this->bearCross = _pf_script_state_checkpoint_->_pf_value_10;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->diMinus = 0.0;
        this->adxVal = 0.0;
        this->bullCross = false;
        this->bearCross = false;
