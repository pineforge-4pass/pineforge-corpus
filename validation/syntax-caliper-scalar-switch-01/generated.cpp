...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_1 = decltype(this->_ta_ema_1)(1);
        this->_precalc__ta_ema_1 = decltype(this->_precalc__ta_ema_1){};
        this->_ta_sma_2 = decltype(this->_ta_sma_2)(1);
        this->_precalc__ta_sma_2 = decltype(this->_precalc__ta_sma_2){};
        this->_ta_ema_3 = decltype(this->_ta_ema_3)(113);
        ...
        this->filterMode = std::string("");
        this->baseLength = 0;
        this->lengthScale = 0.0;
        this->confirmationLength = 0;
