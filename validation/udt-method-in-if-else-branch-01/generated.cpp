...
inline bool is_na(const Regime& _z) { return _z.__pf_id < 0; }
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Regime> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bull)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bear)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::flat)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Regime& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bull)>::take(value.bull),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bear)>::take(value.bear),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::flat)>::take(value.flat),
        };
    }
    static void restore(_PFUdtRecord_Regime& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bull)>::restore(value.bull, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::bear)>::restore(value.bear, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Regime::flat)>::restore(value.flat, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Regime, _PFUdtRecord_Regime>> {
    using arena_type = _PFUdtArena<Regime, _PFUdtRecord_Regime>;
...
public:
    ...
    _PFUdtArena<Regime, _PFUdtRecord_Regime> _pf_udt_Regime{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Regime)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::regime)>::snapshot_type _pf_value_4;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::bullStreak)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ignored)>::snapshot_type _pf_value_8;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Regime)>::take(_pf_udt_Regime),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::bullStreak)>::take(bullStreak),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_ignored)>::take(_ignored),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Regime)>::restore(this->_pf_udt_Regime, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::regime)>::restore(this->regime, _pf_script_state_checkpoint_->_pf_value_4);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::bullStreak)>::restore(this->bullStreak, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ignored)>::restore(this->_ignored, _pf_script_state_checkpoint_->_pf_value_8);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Regime.reset_for_run();
        ...
        this->regime = decltype(this->regime){};
        this->emaFast = 0.0;
        this->emaSlow = 0.0;
        this->bullStreak = 0;
        this->_ignored = 0;
    ...
    int _udt_Regime_tag(Regime self, int bucket) {
        if (([&]{ auto _pna_l = (bucket); auto _pna_r = (1); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l == _pna_r); }())) {
            _pf_udt_Regime.get(self).bull = (_pf_udt_Regime.read(self).bull + 1);
            _pf_udt_Regime.get(self).bear = 0;
            _pf_udt_Regime.get(self).flat = 0;
        } else
        if (([&]{ auto _pna_l = (bucket); auto _pna_r = ((-1)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }())) {
            _pf_udt_Regime.get(self).bear = (_pf_udt_Regime.read(self).bear + 1);
            _pf_udt_Regime.get(self).bull = 0;
            _pf_udt_Regime.get(self).flat = 0;
        } else {
            _pf_udt_Regime.get(self).flat = (_pf_udt_Regime.read(self).flat + 1);
            _pf_udt_Regime.get(self).bull = 0;
            _pf_udt_Regime.get(self).bear = 0;
        }
        return _pf_udt_Regime.read(self).bull;
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (([&]{ auto _pna_l = (emaFast); auto _pna_r = ((emaSlow * 0.999)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }())) {
            _ignored = _udt_Regime_tag(regime, (-1));
            bullStreak = _pf_udt_Regime.read(regime).bull;
        } else {
            _ignored = _udt_Regime_tag(regime, 0);
            bullStreak = _pf_udt_Regime.read(regime).bull;
        }
        if (((!(is_na(bullStreak)) && ([&]{ auto _pna_l = (bullStreak); auto _pna_r = (3); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }())) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("entry long"), "", 0, -1);
        }
        if ((([&]{ auto _pna_l = (_pf_udt_Regime.read(regime).bear); auto _pna_r = (3); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }()) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
