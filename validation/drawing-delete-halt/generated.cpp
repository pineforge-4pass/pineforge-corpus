...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::entries) _pf_value_4;
        decltype(GeneratedStrategy::sma) _pf_value_5;
        decltype(GeneratedStrategy::level) _pf_value_6;
        decltype(GeneratedStrategy::eUp) _pf_value_7;
        decltype(GeneratedStrategy::eDn) _pf_value_8;
        decltype(GeneratedStrategy::_pf_lines_) _pf_value_9;
        decltype(GeneratedStrategy::_pf_boxes_) _pf_value_10;
        decltype(GeneratedStrategy::_pf_labels_) _pf_value_11;
        decltype(GeneratedStrategy::_pf_linefills_) _pf_value_12;
    ...
    void restore_script_state() override {
        ...
        this->entries = _pf_script_state_checkpoint_->_pf_value_4;
        this->sma = _pf_script_state_checkpoint_->_pf_value_5;
        this->level = _pf_script_state_checkpoint_->_pf_value_6;
        this->eUp = _pf_script_state_checkpoint_->_pf_value_7;
        this->eDn = _pf_script_state_checkpoint_->_pf_value_8;
        this->_pf_lines_ = _pf_script_state_checkpoint_->_pf_value_9;
        this->_pf_boxes_ = _pf_script_state_checkpoint_->_pf_value_10;
        this->_pf_labels_ = _pf_script_state_checkpoint_->_pf_value_11;
        this->_pf_linefills_ = _pf_script_state_checkpoint_->_pf_value_12;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->entries = decltype(this->entries)(0);
        this->sma = 0.0;
        this->level = 0.0;
        this->eUp = false;
        this->eDn = false;
