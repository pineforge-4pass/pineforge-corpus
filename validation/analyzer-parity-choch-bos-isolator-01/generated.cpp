...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->lastSwingHigh = decltype(this->lastSwingHigh)(na<double>());
        this->lastSwingLow = decltype(this->lastSwingLow)(na<double>());
        this->prevSwingHigh = decltype(this->prevSwingHigh)(na<double>());
        this->prevSwingLow = decltype(this->prevSwingLow)(na<double>());
        this->structureDirection = decltype(this->structureDirection)(0);
        this->i_pivot = 0;
        this->pivotHigh = 0.0;
        this->pivotLow = 0.0;
        this->bosUp = false;
        ...
        this->any_bull_event = false;
        this->any_bear_event = false;
        this->c_bu = std::string("");
        this->c_bd = std::string("");
