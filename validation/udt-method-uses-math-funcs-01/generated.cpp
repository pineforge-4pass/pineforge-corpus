...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Box> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::min_offset)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::max_offset)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Box& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Box::min_offset)>::take(value.min_offset),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Box::max_offset)>::take(value.max_offset),
        };
    }
    static void restore(_PFUdtRecord_Box& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::min_offset)>::restore(value.min_offset, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Box::max_offset)>::restore(value.max_offset, snapshot._pf_field_1);
    }
};
...
public:
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::bx)>::snapshot_type _pf_value_6;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::bx)>::take(bx),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::bx)>::restore(this->bx, _pf_script_state_checkpoint_->_pf_value_6);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (((history_advances_new_bar() ? _ta_crossover_4.compute(emaFast, emaSlow) : _ta_crossover_4.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            ...
            strategy_exit(std::string("LX"), std::string("L"), _udt_Box_clampedLimit(bx, current_bar_.close, atrVal), _udt_Box_clampedStop(bx, current_bar_.close, atrVal), na<double>(), na<double>(), na<double>(), 100.0, std::string("bracket long"), na<double>(), "", na<double>(), na<double>());
        }
    }
