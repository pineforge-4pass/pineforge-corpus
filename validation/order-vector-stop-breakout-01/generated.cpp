...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_atr_1 = decltype(this->_ta_atr_1)(15);
        this->_precalc__ta_atr_1 = decltype(this->_precalc__ta_atr_1){};
        this->_ta_sma_2 = decltype(this->_ta_sma_2)(28);
        this->_ta_highest_3 = decltype(this->_ta_highest_3)(28);
        this->_precalc__ta_highest_3 = decltype(this->_precalc__ta_highest_3){};
        this->_use_precalc = false;
        this->entryBar = decltype(this->entryBar)(na<int>());
        this->_strat_position_size = decltype(this->_strat_position_size){};
        this->_hist_call_1 = decltype(this->_hist_call_1){};
        this->breakoutLength = 0;
        this->atrLength = 0;
        this->contractionRatio = 0.0;
        this->entryBufferAtr = 0.0;
        this->stopAtr = 0.0;
        this->maxBars = 0;
        this->atrValue = 0.0;
        this->atrBaseline = 0.0;
        this->breakoutLevel = 0.0;
        this->contracted = false;
        this->stopTrigger = 0.0;
