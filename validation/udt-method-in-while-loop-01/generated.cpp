...
inline bool is_na(const Ramp& _z) { return _z.__pf_id < 0; }
...
struct _PFUdtRecord_Ramp {
    int64_t counter = 0;
    int64_t green_count = 0;
};
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Ramp> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::counter)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::green_count)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Ramp& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::counter)>::take(value.counter),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::green_count)>::take(value.green_count),
        };
    }
    static void restore(_PFUdtRecord_Ramp& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::counter)>::restore(value.counter, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Ramp::green_count)>::restore(value.green_count, snapshot._pf_field_1);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Ramp, _PFUdtRecord_Ramp>> {
    using arena_type = _PFUdtArena<Ramp, _PFUdtRecord_Ramp>;
...
public:
    ...
    _PFUdtArena<Ramp, _PFUdtRecord_Ramp> _pf_udt_Ramp{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Ramp)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_crossunder_4)>::snapshot_type _pf_value_5;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_close)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_open)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::ramp)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::safety)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_c)>::snapshot_type _pf_value_10;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::snapshot_type _pf_value_13;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::snapshot_type _pf_value_14;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::snapshot_type _pf_value_15;
    };
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Ramp)>::take(_pf_udt_Ramp),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_crossunder_4)>::take(_ta_crossunder_4),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_s_close)>::take(_s_close),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_s_open)>::take(_s_open),
            _PFCheckpointTraits<decltype(GeneratedStrategy::ramp)>::take(ramp),
            _PFCheckpointTraits<decltype(GeneratedStrategy::safety)>::take(safety),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_c)>::take(_c),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Ramp)>::restore(this->_pf_udt_Ramp, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_crossunder_4)>::restore(this->_ta_crossunder_4, _pf_script_state_checkpoint_->_pf_value_5);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_close)>::restore(this->_s_close, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_open)>::restore(this->_s_open, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::ramp)>::restore(this->ramp, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::safety)>::restore(this->safety, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_c)>::restore(this->_c, _pf_script_state_checkpoint_->_pf_value_10);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_var_initialized)>::restore(this->_var_initialized, _pf_script_state_checkpoint_->_pf_value_13);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_ta_initialized_)>::restore(this->_ta_initialized_, _pf_script_state_checkpoint_->_pf_value_14);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_inputs_initialized_)>::restore(this->_inputs_initialized_, _pf_script_state_checkpoint_->_pf_value_15);
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Ramp.reset_for_run();
    ...
    int _udt_Ramp_tick(Ramp self) {
        ...
        _pf_udt_Ramp.get(self).counter = (_pf_udt_Ramp.read(self).counter - 1);
        return _pf_udt_Ramp.read(self).counter;
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        _pf_udt_Ramp.get(ramp).counter = 10;
        _pf_udt_Ramp.get(ramp).green_count = 0;
        safety = 0;
        while ((([&]{ auto _pna_l = (_pf_udt_Ramp.read(ramp).counter); auto _pna_r = (0); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l > _pna_r); }()) && ([&]{ auto _pna_l = (safety); auto _pna_r = (12); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l < _pna_r); }()))) {
        ...
        if (((([&]{ auto _pna_l = (_pf_udt_Ramp.read(ramp).green_count); auto _pna_r = (7); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l >= _pna_r); }()) && (history_advances_new_bar() ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow))) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("entry long"), "", 0, -1);
        }
        if (((history_advances_new_bar() ? _ta_crossunder_4.compute(emaFast, emaSlow) : _ta_crossunder_4.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 249108103187ULL);
        }
    }
