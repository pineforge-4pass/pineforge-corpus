...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_2 = decltype(this->_ta_ema_2)(54);
        ...
        this->_ta_atr_4 = decltype(this->_ta_atr_4)(16);
        ...
        this->configuration = std::string("");
        this->fastLength = 0;
        this->slowLength = 0;
        this->atrLength = 0;
        this->maximumAtrLoss = 0.0;
        this->normalized = std::string("");
        this->trendRulePresent = false;
        this->confirmationRequested = false;
        this->guardedRisk = false;
        this->fastLine = 0.0;
        this->slowLine = 0.0;
        this->rsiValue = 0.0;
        this->atrValue = 0.0;
        this->confirmationLevel = 0.0;
        this->effectiveRisk = 0.0;
