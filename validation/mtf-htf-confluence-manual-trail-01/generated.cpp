...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::entryTP) _pf_value_9;
        decltype(GeneratedStrategy::trailStop) _pf_value_10;
        ...
        decltype(GeneratedStrategy::i_trail_mult) _pf_value_18;
        decltype(GeneratedStrategy::emaFast) _pf_value_19;
        decltype(GeneratedStrategy::emaSlow) _pf_value_20;
        decltype(GeneratedStrategy::atrVal) _pf_value_21;
        decltype(GeneratedStrategy::_htfEmaSeries) _pf_value_22;
        decltype(GeneratedStrategy::htfClose) _pf_value_23;
        decltype(GeneratedStrategy::htfEma) _pf_value_24;
        decltype(GeneratedStrategy::htfBull) _pf_value_25;
        decltype(GeneratedStrategy::longSig) _pf_value_26;
        decltype(GeneratedStrategy::candidate) _pf_value_27;
        decltype(GeneratedStrategy::_var_initialized) _pf_value_28;
        decltype(GeneratedStrategy::_ta_initialized_) _pf_value_29;
        decltype(GeneratedStrategy::_inputs_initialized_) _pf_value_30;
    };
    ...
    void restore_script_state() override {
        ...
        this->entryTP = _pf_script_state_checkpoint_->_pf_value_9;
        this->trailStop = _pf_script_state_checkpoint_->_pf_value_10;
        ...
        this->i_trail_mult = _pf_script_state_checkpoint_->_pf_value_18;
        this->emaFast = _pf_script_state_checkpoint_->_pf_value_19;
        this->emaSlow = _pf_script_state_checkpoint_->_pf_value_20;
        this->atrVal = _pf_script_state_checkpoint_->_pf_value_21;
        this->_htfEmaSeries = _pf_script_state_checkpoint_->_pf_value_22;
        this->htfClose = _pf_script_state_checkpoint_->_pf_value_23;
        this->htfEma = _pf_script_state_checkpoint_->_pf_value_24;
        this->htfBull = _pf_script_state_checkpoint_->_pf_value_25;
        this->longSig = _pf_script_state_checkpoint_->_pf_value_26;
        this->candidate = _pf_script_state_checkpoint_->_pf_value_27;
        this->_var_initialized = _pf_script_state_checkpoint_->_pf_value_28;
        this->_ta_initialized_ = _pf_script_state_checkpoint_->_pf_value_29;
        this->_inputs_initialized_ = _pf_script_state_checkpoint_->_pf_value_30;
    }
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->trailStop = decltype(this->trailStop)(na<double>());
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && !(is_na(atrVal)))) {
            candidate = (current_bar_.close - (atrVal * i_trail_mult));
            if ((!(is_na(trailStop)) && ([&]{ auto _pna_l = (candidate); auto _pna_r = (trailStop); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
                trailStop = candidate;
            }
            strategy_exit(std::string("LX"), std::string("L"), entryTP, trailStop, na<double>(), na<double>(), na<double>(), 100.0, std::string("manual trail"), na<double>(), "", na<double>(), na<double>());
        }
    }
