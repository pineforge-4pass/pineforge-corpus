...
inline bool is_na(const Trend& _z) { return _z.__pf_id < 0; }
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Trend> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Trend::lookback)>::snapshot_type _pf_field_0;
    };
    static snapshot_type take(const _PFUdtRecord_Trend& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Trend::lookback)>::take(value.lookback),
        };
    }
    static void restore(_PFUdtRecord_Trend& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Trend::lookback)>::restore(value.lookback, snapshot._pf_field_0);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Trend, _PFUdtRecord_Trend>> {
    using arena_type = _PFUdtArena<Trend, _PFUdtRecord_Trend>;
...
public:
    ...
    _PFUdtArena<Trend, _PFUdtRecord_Trend> _pf_udt_Trend{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Trend)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_high)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_low)>::snapshot_type _pf_value_8;
        _PFCheckpointTraits<decltype(GeneratedStrategy::trend)>::snapshot_type _pf_value_9;
        _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::snapshot_type _pf_value_10;
        _PFCheckpointTraits<decltype(GeneratedStrategy::swing)>::snapshot_type _pf_value_11;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::snapshot_type _pf_value_12;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::snapshot_type _pf_value_13;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Trend)>::take(_pf_udt_Trend),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_s_high)>::take(_s_high),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_s_low)>::take(_s_low),
            _PFCheckpointTraits<decltype(GeneratedStrategy::trend)>::take(trend),
            _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::take(r),
            _PFCheckpointTraits<decltype(GeneratedStrategy::swing)>::take(swing),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Trend)>::restore(this->_pf_udt_Trend, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_high)>::restore(this->_s_high, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_s_low)>::restore(this->_s_low, _pf_script_state_checkpoint_->_pf_value_8);
        _PFCheckpointTraits<decltype(GeneratedStrategy::trend)>::restore(this->trend, _pf_script_state_checkpoint_->_pf_value_9);
        _PFCheckpointTraits<decltype(GeneratedStrategy::r)>::restore(this->r, _pf_script_state_checkpoint_->_pf_value_10);
        _PFCheckpointTraits<decltype(GeneratedStrategy::swing)>::restore(this->swing, _pf_script_state_checkpoint_->_pf_value_11);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::restore(this->emaFast, _pf_script_state_checkpoint_->_pf_value_12);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::restore(this->emaSlow, _pf_script_state_checkpoint_->_pf_value_13);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Trend.reset_for_run();
        ...
        this->trend = decltype(this->trend){};
        this->r = 0.0;
        this->swing = 0.0;
        this->emaFast = 0.0;
        this->emaSlow = 0.0;
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (((((history_advances_new_bar() ? _ta_crossover_3.compute(emaFast, emaSlow) : _ta_crossover_3.recompute(emaFast, emaSlow)) && ([&]{ auto _pna_l = (r); auto _pna_r = (0.01); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) && ([&]{ auto _pna_l = (swing); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
