...
public:
    ...
    void on_bar(const Bar& bar) override {
        ...
        slope = (mid - lr_lag);
        width = ((is_first_tick_ ? _ta_atr_5.compute(current_bar_.high, current_bar_.low, current_bar_.close) : _ta_atr_5.recompute(current_bar_.high, current_bar_.low, current_bar_.close)) * i_atr_mult);
