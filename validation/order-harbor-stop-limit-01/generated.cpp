...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_highest_2 = decltype(this->_ta_highest_2)(35);
        this->_precalc__ta_highest_2 = decltype(this->_precalc__ta_highest_2){};
        this->_ta_highest_3 = decltype(this->_ta_highest_3)(35);
        this->_precalc__ta_highest_3 = decltype(this->_precalc__ta_highest_3){};
        this->_ta_lowest_4 = decltype(this->_ta_lowest_4)(35);
        this->_precalc__ta_lowest_4 = decltype(this->_precalc__ta_lowest_4){};
        this->_use_precalc = false;
        this->fillBar = decltype(this->fillBar)(na<int>());
        this->_strat_position_size = decltype(this->_strat_position_size){};
        this->_hist_call_1 = decltype(this->_hist_call_1){};
        this->_hist_call_2 = decltype(this->_hist_call_2){};
        this->_hist_call_3 = decltype(this->_hist_call_3){};
        this->harborLength = 0;
        this->atrLength = 0;
        this->activationAtr = 0.0;
        this->limitAtr = 0.0;
        this->stopAtr = 0.0;
        this->maximumBars = 0;
        this->atrValue = 0.0;
