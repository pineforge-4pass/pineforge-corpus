...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::i_pivot) _pf_value_5;
        decltype(GeneratedStrategy::ph) _pf_value_6;
        decltype(GeneratedStrategy::pl) _pf_value_7;
        decltype(GeneratedStrategy::break_up) _pf_value_8;
        decltype(GeneratedStrategy::break_down) _pf_value_9;
    ...
    void restore_script_state() override {
        ...
        this->i_pivot = _pf_script_state_checkpoint_->_pf_value_5;
        this->ph = _pf_script_state_checkpoint_->_pf_value_6;
        this->pl = _pf_script_state_checkpoint_->_pf_value_7;
        this->break_up = _pf_script_state_checkpoint_->_pf_value_8;
        this->break_down = _pf_script_state_checkpoint_->_pf_value_9;
