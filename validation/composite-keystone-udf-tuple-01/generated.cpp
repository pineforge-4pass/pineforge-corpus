...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_atr_2 = decltype(this->_ta_atr_2)(27);
        ...
        this->widthMultiplier = 0.0;
        this->targetMultiplier = 0.0;
        this->basis = 0.0;
        this->upperBand = 0.0;
        this->lowerBand = 0.0;
    ...
    std::tuple<double, double, double, double> channel_cs0(double source, int length, double widthMultiplier) {
        ...
        double width = ((history_advances_new_bar() ? _ta_atr_2.compute(current_bar_.high, current_bar_.low, current_bar_.close, prev_chart_close()) : _ta_atr_2.recompute(current_bar_.high, current_bar_.low, current_bar_.close, prev_chart_close())) * widthMultiplier);
