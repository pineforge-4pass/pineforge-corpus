...
inline bool is_na(const Counters& _z) { return _z.__pf_id < 0; }
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Counters> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bull_run)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bear_run)>::snapshot_type _pf_field_1;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::flat_run)>::snapshot_type _pf_field_2;
    };
    static snapshot_type take(const _PFUdtRecord_Counters& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bull_run)>::take(value.bull_run),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bear_run)>::take(value.bear_run),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::flat_run)>::take(value.flat_run),
        };
    }
    static void restore(_PFUdtRecord_Counters& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bull_run)>::restore(value.bull_run, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::bear_run)>::restore(value.bear_run, snapshot._pf_field_1);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Counters::flat_run)>::restore(value.flat_run, snapshot._pf_field_2);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Counters, _PFUdtRecord_Counters>> {
    using arena_type = _PFUdtArena<Counters, _PFUdtRecord_Counters>;
...
public:
    ...
    _PFUdtArena<Counters, _PFUdtRecord_Counters> _pf_udt_Counters{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Counters)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::c)>::snapshot_type _pf_value_4;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::snapshot_type _pf_value_5;
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::regime)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::active)>::snapshot_type _pf_value_8;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Counters)>::take(_pf_udt_Counters),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::active)>::take(active),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Counters)>::restore(this->_pf_udt_Counters, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::c)>::restore(this->c, _pf_script_state_checkpoint_->_pf_value_4);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaFast)>::restore(this->emaFast, _pf_script_state_checkpoint_->_pf_value_5);
        _PFCheckpointTraits<decltype(GeneratedStrategy::emaSlow)>::restore(this->emaSlow, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::regime)>::restore(this->regime, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::active)>::restore(this->active, _pf_script_state_checkpoint_->_pf_value_8);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Counters.reset_for_run();
    ...
    int _udt_Counters_bumpBull(Counters self) {
        _pf_udt_Counters.get(self).bull_run = (_pf_udt_Counters.read(self).bull_run + 1);
        _pf_udt_Counters.get(self).bear_run = 0;
        _pf_udt_Counters.get(self).flat_run = 0;
        return _pf_udt_Counters.read(self).bull_run;
    }

    int _udt_Counters_bumpBear(Counters self) {
        _pf_udt_Counters.get(self).bear_run = (_pf_udt_Counters.read(self).bear_run + 1);
        _pf_udt_Counters.get(self).bull_run = 0;
        _pf_udt_Counters.get(self).flat_run = 0;
        return _pf_udt_Counters.read(self).bear_run;
    }

    int _udt_Counters_bumpFlat(Counters self) {
        _pf_udt_Counters.get(self).flat_run = (_pf_udt_Counters.read(self).flat_run + 1);
        _pf_udt_Counters.get(self).bull_run = 0;
        _pf_udt_Counters.get(self).bear_run = 0;
        return _pf_udt_Counters.read(self).flat_run;
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        regime = ((([&]{ auto _pna_l = (emaFast); auto _pna_r = ((emaSlow * 1.001)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }())) ? (std::string("bull")) : (((([&]{ auto _pna_l = (emaFast); auto _pna_r = ((emaSlow * 0.999)); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }())) ? (std::string("bear")) : (std::string("flat")))));
