...
inline bool is_na(const Acc& _z) { return _z.__pf_id < 0; }
...
template <>
struct _PFCheckpointTraits<_PFUdtRecord_Acc> {
    struct snapshot_type {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::total)>::snapshot_type _pf_field_0;
        _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::n)>::snapshot_type _pf_field_1;
    };
    static snapshot_type take(const _PFUdtRecord_Acc& value) {
        return snapshot_type{
            _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::total)>::take(value.total),
            _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::n)>::take(value.n),
        };
    }
    static void restore(_PFUdtRecord_Acc& value, const snapshot_type& snapshot) {
        _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::total)>::restore(value.total, snapshot._pf_field_0);
        _PFCheckpointTraits<decltype(_PFUdtRecord_Acc::n)>::restore(value.n, snapshot._pf_field_1);
    }
};

template <>
struct _PFCheckpointTraits<_PFUdtArena<Acc, _PFUdtRecord_Acc>> {
    using arena_type = _PFUdtArena<Acc, _PFUdtRecord_Acc>;
...
public:
    ...
    _PFUdtArena<Acc, _PFUdtRecord_Acc> _pf_udt_Acc{&_pf_udt_undo};
    ta::EMA _ta_ema_1;
    ...
    struct _PFScriptState {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Acc)>::snapshot_type _pf_value_1;
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::acc)>::snapshot_type _pf_value_6;
        _PFCheckpointTraits<decltype(GeneratedStrategy::_r)>::snapshot_type _pf_value_7;
        _PFCheckpointTraits<decltype(GeneratedStrategy::avg5)>::snapshot_type _pf_value_8;
    ...
    void snapshot_script_state() override {
        _pf_script_state_checkpoint_.emplace(_PFScriptState{
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Acc)>::take(_pf_udt_Acc),
            ...
            _PFCheckpointTraits<decltype(GeneratedStrategy::acc)>::take(acc),
            _PFCheckpointTraits<decltype(GeneratedStrategy::_r)>::take(_r),
            _PFCheckpointTraits<decltype(GeneratedStrategy::avg5)>::take(avg5),
    ...
    void restore_script_state() override {
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::_pf_udt_Acc)>::restore(this->_pf_udt_Acc, _pf_script_state_checkpoint_->_pf_value_1);
        ...
        _PFCheckpointTraits<decltype(GeneratedStrategy::acc)>::restore(this->acc, _pf_script_state_checkpoint_->_pf_value_6);
        _PFCheckpointTraits<decltype(GeneratedStrategy::_r)>::restore(this->_r, _pf_script_state_checkpoint_->_pf_value_7);
        _PFCheckpointTraits<decltype(GeneratedStrategy::avg5)>::restore(this->avg5, _pf_script_state_checkpoint_->_pf_value_8);
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_pf_udt_Acc.reset_for_run();
    ...
    double _udt_Acc_add(Acc self, double v) {
        _pf_udt_Acc.get(self).total = (_pf_udt_Acc.read(self).total + v);
        _pf_udt_Acc.get(self).n = (_pf_udt_Acc.read(self).n + 1);
        return _pf_udt_Acc.read(self).total;
    }

    double _udt_Acc_mean(Acc self) {
        return ((([&]{ auto _pna_l = (_pf_udt_Acc.read(self).n); auto _pna_r = (0); return !is_na(_pna_l) && !is_na(_pna_r) && (_pna_l > _pna_r); }())) ? (((double)(_pf_udt_Acc.read(self).total) / (double)((double)(_pf_udt_Acc.read(self).n)))) : (0.0));
    }

    int _udt_Acc_reset(Acc self) {
        _pf_udt_Acc.get(self).total = 0.0;
        _pf_udt_Acc.get(self).n = 0;
        return 0;
    }
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if (((([&]{ auto _pna_l = (avg5); auto _pna_r = (emaSlow); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()) && (history_advances_new_bar() ? _ta_crossover_2.compute(current_bar_.close, emaSlow) : _ta_crossover_2.recompute(current_bar_.close, emaSlow))) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && (_pfc_eq); }()))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("entry long"), "", 0, -1);
        }
        if (((history_advances_new_bar() ? _ta_crossunder_3.compute(current_bar_.close, emaSlow) : _ta_crossunder_3.recompute(current_bar_.close, emaSlow)) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
            strategy_close(std::string("L"), std::string("exit long"), na<double>(), na<double>(), false, 236223201299ULL);
        }
    }
