...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::_ta_rsi_1) _pf_value_2;
        decltype(GeneratedStrategy::_ta_crossover_2) _pf_value_3;
        decltype(GeneratedStrategy::_ta_crossunder_3) _pf_value_4;
        decltype(GeneratedStrategy::_sec0__ta_rsi_1) _pf_value_5;
        decltype(GeneratedStrategy::htfRsi) _pf_value_6;
        decltype(GeneratedStrategy::longCond) _pf_value_7;
        decltype(GeneratedStrategy::shortCond) _pf_value_8;
    ...
    void restore_script_state() override {
        ...
        this->_ta_rsi_1 = _pf_script_state_checkpoint_->_pf_value_2;
        this->_ta_crossover_2 = _pf_script_state_checkpoint_->_pf_value_3;
        this->_ta_crossunder_3 = _pf_script_state_checkpoint_->_pf_value_4;
        this->_sec0__ta_rsi_1 = _pf_script_state_checkpoint_->_pf_value_5;
        this->htfRsi = _pf_script_state_checkpoint_->_pf_value_6;
        this->longCond = _pf_script_state_checkpoint_->_pf_value_7;
        this->shortCond = _pf_script_state_checkpoint_->_pf_value_8;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        htfRsi = _req_sec_0;
        longCond = (history_advances_new_bar() ? _ta_crossover_2.compute(htfRsi, 50) : _ta_crossover_2.recompute(htfRsi, 50));
        shortCond = (history_advances_new_bar() ? _ta_crossunder_3.compute(htfRsi, 50) : _ta_crossunder_3.recompute(htfRsi, 50));
        if (longCond) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, "", "", 0, -1);
        }
        if ((shortCond && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) && !_pfc_eq); }()))) {
