...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::medLen) _pf_value_4;
        decltype(GeneratedStrategy::emaLen) _pf_value_5;
        decltype(GeneratedStrategy::medVal) _pf_value_6;
        decltype(GeneratedStrategy::emaVal) _pf_value_7;
    ...
    void restore_script_state() override {
        ...
        this->medLen = _pf_script_state_checkpoint_->_pf_value_4;
        this->emaLen = _pf_script_state_checkpoint_->_pf_value_5;
        this->medVal = _pf_script_state_checkpoint_->_pf_value_6;
        this->emaVal = _pf_script_state_checkpoint_->_pf_value_7;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_median_1 = decltype(this->_ta_median_1)(20);
        this->_precalc__ta_median_1 = decltype(this->_precalc__ta_median_1){};
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        medVal = (history_advances_new_bar() ? _ta_median_1.compute(current_bar_.close) : _ta_median_1.recompute(current_bar_.close));
        emaVal = (history_advances_new_bar() ? _ta_ema_2.compute(current_bar_.close) : _ta_ema_2.recompute(current_bar_.close));
        longCond = (history_advances_new_bar() ? _ta_crossover_3.compute(medVal, emaVal) : _ta_crossover_3.recompute(medVal, emaVal));
        shortCond = (history_advances_new_bar() ? _ta_crossunder_4.compute(medVal, emaVal) : _ta_crossunder_4.recompute(medVal, emaVal));
        if (longCond) {
