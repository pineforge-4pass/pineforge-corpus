...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::cciLen) _pf_value_5;
        decltype(GeneratedStrategy::obLevel) _pf_value_6;
        decltype(GeneratedStrategy::osLevel) _pf_value_7;
        decltype(GeneratedStrategy::cciVal) _pf_value_8;
    ...
    void restore_script_state() override {
        ...
        this->cciLen = _pf_script_state_checkpoint_->_pf_value_5;
        this->obLevel = _pf_script_state_checkpoint_->_pf_value_6;
        this->osLevel = _pf_script_state_checkpoint_->_pf_value_7;
        this->cciVal = _pf_script_state_checkpoint_->_pf_value_8;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_cci_1 = decltype(this->_ta_cci_1)(20);
        this->_precalc__ta_cci_1 = decltype(this->_precalc__ta_cci_1){};
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        if ((([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) && !_pfc_eq); }()) && (history_advances_new_bar() ? _ta_crossover_5.compute(cciVal, 0) : _ta_crossover_5.recompute(cciVal, 0)))) {
