...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::i_pivot) _pf_value_8;
        decltype(GeneratedStrategy::i_rr) _pf_value_9;
        decltype(GeneratedStrategy::i_fast) _pf_value_10;
        decltype(GeneratedStrategy::i_slow) _pf_value_11;
        decltype(GeneratedStrategy::ph) _pf_value_12;
        decltype(GeneratedStrategy::pl) _pf_value_13;
        decltype(GeneratedStrategy::ema_fast) _pf_value_14;
        decltype(GeneratedStrategy::ema_slow) _pf_value_15;
        decltype(GeneratedStrategy::long_signal) _pf_value_16;
        decltype(GeneratedStrategy::short_signal) _pf_value_17;
        decltype(GeneratedStrategy::entry_px) _pf_value_18;
        decltype(GeneratedStrategy::sl_px) _pf_value_19;
        decltype(GeneratedStrategy::tp_px) _pf_value_20;
    ...
    void restore_script_state() override {
        ...
        this->i_pivot = _pf_script_state_checkpoint_->_pf_value_8;
        this->i_rr = _pf_script_state_checkpoint_->_pf_value_9;
        this->i_fast = _pf_script_state_checkpoint_->_pf_value_10;
        this->i_slow = _pf_script_state_checkpoint_->_pf_value_11;
        this->ph = _pf_script_state_checkpoint_->_pf_value_12;
        this->pl = _pf_script_state_checkpoint_->_pf_value_13;
        this->ema_fast = _pf_script_state_checkpoint_->_pf_value_14;
        this->ema_slow = _pf_script_state_checkpoint_->_pf_value_15;
        this->long_signal = _pf_script_state_checkpoint_->_pf_value_16;
        this->short_signal = _pf_script_state_checkpoint_->_pf_value_17;
        this->entry_px = _pf_script_state_checkpoint_->_pf_value_18;
        this->sl_px = _pf_script_state_checkpoint_->_pf_value_19;
        this->tp_px = _pf_script_state_checkpoint_->_pf_value_20;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_3 = decltype(this->_ta_ema_3)(5);
        this->_precalc__ta_ema_3 = decltype(this->_precalc__ta_ema_3){};
        this->_ta_ema_4 = decltype(this->_ta_ema_4)(13);
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        ema_slow = (history_advances_new_bar() ? _ta_ema_4.compute(current_bar_.close) : _ta_ema_4.recompute(current_bar_.close));
        long_signal = (history_advances_new_bar() ? _ta_crossover_5.compute(ema_fast, ema_slow) : _ta_crossover_5.recompute(ema_fast, ema_slow));
        short_signal = (history_advances_new_bar() ? _ta_crossunder_6.compute(ema_fast, ema_slow) : _ta_crossunder_6.recompute(ema_fast, ema_slow));
        if (((long_signal && !(is_na(last_pl))) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l < _pfc_r) || _pfc_eq); }()))) {
            strategy_entry(std::string("L"), true, na<double>(), na<double>(), 1, std::string("pivot long"), "", 0, -1);
        }
        if (((short_signal && !(is_na(last_ph))) && ([&]{ auto _pna_l = (signed_position_size()); auto _pna_r = (0); double _pfc_l = static_cast<double>(_pna_l); double _pfc_r = static_cast<double>(_pna_r); bool _pfc_eq = (_pfc_l == _pfc_r) || (std::isfinite(_pfc_l) && std::isfinite(_pfc_r) && std::fabs(_pfc_l - _pfc_r) <= 1e-10); return !is_na(_pna_l) && !is_na(_pna_r) && ((_pfc_l > _pfc_r) || _pfc_eq); }()))) {
