...
public:
    ...
    struct _PFScriptState {
        ...
        decltype(GeneratedStrategy::i_band_len) _pf_value_4;
        decltype(GeneratedStrategy::i_atr_len) _pf_value_5;
        decltype(GeneratedStrategy::i_atr_mult) _pf_value_6;
        decltype(GeneratedStrategy::band) _pf_value_7;
        decltype(GeneratedStrategy::vol) _pf_value_8;
        decltype(GeneratedStrategy::upper) _pf_value_9;
        decltype(GeneratedStrategy::lower) _pf_value_10;
        decltype(GeneratedStrategy::cross_up) _pf_value_11;
        decltype(GeneratedStrategy::cross_down) _pf_value_12;
    ...
    void restore_script_state() override {
        ...
        this->i_band_len = _pf_script_state_checkpoint_->_pf_value_4;
        this->i_atr_len = _pf_script_state_checkpoint_->_pf_value_5;
        this->i_atr_mult = _pf_script_state_checkpoint_->_pf_value_6;
        this->band = _pf_script_state_checkpoint_->_pf_value_7;
        this->vol = _pf_script_state_checkpoint_->_pf_value_8;
        this->upper = _pf_script_state_checkpoint_->_pf_value_9;
        this->lower = _pf_script_state_checkpoint_->_pf_value_10;
        this->cross_up = _pf_script_state_checkpoint_->_pf_value_11;
        this->cross_down = _pf_script_state_checkpoint_->_pf_value_12;
...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        cross_up = (history_advances_new_bar() ? _ta_crossover_3.compute(current_bar_.close, upper) : _ta_crossover_3.recompute(current_bar_.close, upper));
        cross_down = (history_advances_new_bar() ? _ta_crossunder_4.compute(current_bar_.close, lower) : _ta_crossunder_4.recompute(current_bar_.close, lower));
