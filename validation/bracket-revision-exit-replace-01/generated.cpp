...
#error "Generated lifecycle reset requires a matching PineForge engine; rebuild with script-run preparation support"
    ...
    void prepare_script_run(const Bar* bars, int n, bool allow_precalculation) override {
        ...
        this->_ta_ema_2 = decltype(this->_ta_ema_2)(61);
        ...
        this->admittedAt = decltype(this->admittedAt)(na<int>());
        this->_strat_position_size = decltype(this->_strat_position_size){};
        this->fastLength = 0;
        this->slowLength = 0;
        this->atrLength = 0;
        this->revisionBars = 0;
        this->wideStopAtr = 0.0;
        this->wideTargetAtr = 0.0;
        this->narrowStopAtr = 0.0;
        this->narrowTargetAtr = 0.0;
        this->fastLine = 0.0;
        this->slowLine = 0.0;
        this->atrValue = 0.0;
